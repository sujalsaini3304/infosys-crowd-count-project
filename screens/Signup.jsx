...
export default function Signup() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`${server}/api/send/auth/email`, {
        method: "POST",
        headers: {
      ...
      // Navigate to email verification page with user data and verification code
      navigate("/email/auth", {
        replace: true,
        state: {
          username: formData.username,
